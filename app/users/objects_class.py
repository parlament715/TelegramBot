...
user_1 = my_user(id="6324858739", func="write",
                 role="Воспитатель", name="user_1")
user_2 = my_user(id="819514102", func="read")
user_3 = my_user(id="819514102в", func="write",
                 role="Воспитатель", name="user_3", classroom_number=11)
user_4 = my_user(id="819514102d", func="write",
                 role="Классный советник", name="user_4", classroom_number=10)
